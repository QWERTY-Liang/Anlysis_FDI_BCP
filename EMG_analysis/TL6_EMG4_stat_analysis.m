...
%% ，去除345
%1. 提前量对比
idx_R_FDI=find(AllBehaviour_EMGonsite(:,15)==1 &AllBehaviour_EMGonsite(:,4)==4 &  AllBehaviour_EMGonsite(:,5)~= 3&  AllBehaviour_EMGonsite(:,5)~= 4&  AllBehaviour_EMGonsite(:,5)~= 5 );
idx_R_BCP=find(AllBehaviour_EMGonsite(:,15)==1 &AllBehaviour_EMGonsite(:,4)==44 &  AllBehaviour_EMGonsite(:,5)~= 3&  AllBehaviour_EMGonsite(:,5)~= 4&  AllBehaviour_EMGonsite(:,5)~= 5 );

data1=AllBehaviour_EMGonsite(idx_R_FDI,12);%看提前量
data2=AllBehaviour_EMGonsite(idx_R_BCP,12);
%%
%2. EMG onsite 图 FDI vsBCP 更新后EMGonsite
idx_R_FDI=find(AllBehaviour_EMGonsite(:,4)==4 &  AllBehaviour_EMGonsite(:,5)~= 3&  AllBehaviour_EMGonsite(:,5)~= 4&  AllBehaviour_EMGonsite(:,5)~= 5 );
idx_R_BCP=find(AllBehaviour_EMGonsite(:,4)==44 &  AllBehaviour_EMGonsite(:,5)~= 3&  AllBehaviour_EMGonsite(:,5)~= 4&  AllBehaviour_EMGonsite(:,5)~= 5 );

data1=AllBehaviour_EMGonsite(idx_R_FDI,11);%看提前量
data2=AllBehaviour_EMGonsite(idx_R_BCP,11);
%%
%3. 数据质量对比 动了左手但右边的partial brust的个数
idx_R_FDI=find(AllBehaviour_EMGonsite(:,8)==2 &AllBehaviour_EMGonsite(:,13)<8&AllBehaviour_EMGonsite(:,14)<8 &AllBehaviour_EMGonsite(:,4)==4 &  AllBehaviour_EMGonsite(:,5)~= 3&  AllBehaviour_EMGonsite(:,5)~= 4&  AllBehaviour_EMGonsite(:,5)~= 5 );
idx_R_BCP=find(AllBehaviour_EMGonsite(:,8)==2 &AllBehaviour_EMGonsite(:,13)<8&AllBehaviour_EMGonsite(:,14)<8&AllBehaviour_EMGonsite(:,4)==44 &  AllBehaviour_EMGonsite(:,5)~= 3&  AllBehaviour_EMGonsite(:,5)~= 4&  AllBehaviour_EMGonsite(:,5)~= 5 );

data1=AllBehaviour_EMGonsite(idx_R_FDI,14);%看提前量
data2=AllBehaviour_EMGonsite(idx_R_BCP,14);
