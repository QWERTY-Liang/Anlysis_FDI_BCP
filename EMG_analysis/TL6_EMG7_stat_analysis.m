...
%% ，只要12 和valid
%1. 提前量对比
idx_R_FDI=find(AllBehaviour_EMGonsite(:,15)==1 &EMGonsite_Valid==1 &AllBe(haviour_EMGonsite(:,4)==4 &  AllBehaviour_EMGonsite(:,5)== 1|   AllBehaviour_EMGonsite(:,5)== 2) );
idx_R_BCP=find(AllBehaviour_EMGonsite(:,15)==1 &EMGonsite_Valid==1&AllBehaviour_EMGonsite(:,4)==44 &  (AllBehaviour_EMGonsite(:,5)== 1|   AllBehaviour_EMGonsite(:,5)== 2) );
