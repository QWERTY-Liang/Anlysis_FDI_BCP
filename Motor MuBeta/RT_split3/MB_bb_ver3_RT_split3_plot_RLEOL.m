...
xline([0, 100], '--r', {'EMG onset', 'appx. respT'});xlim([-500, 300]);
hold off
%%%%%%%%%%%%%%%%%%%%%%%
subplot(3,1,2)
...
Ts_idx=131:146; % QRT -320-0ms MB RL HL
%Ts_idx=131:141; % QRT -100-100 Delta RL HL
...
Ts_idx=131:146; % MRT -300-26ms MB RL HL
...
Ts_idx=131:146% SRT -26-188ms RT MB HL
figure
%Ts_idx=125:141;%HL EOL
