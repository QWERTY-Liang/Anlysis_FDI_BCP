...
for sub=1:6% 每个人分别看
    ...
    for i=1:length(AllBehaviour)
        %select trials
        if AllBehaviour(i,8)==1 &&AllBehaviour(i,4)==4% &&&& AllBehaviour(i,3)==0.14%&& AllBehaviour(i,9)==1%&& AllBehaviour(i,3)==0.14%&& AllBehaviour(i,4)==4% && AllBehaviour(i,4)==44
            selected_trials_1(i)=1;
        elseif AllBehaviour(i,8)==2&&AllBehaviour(i,4)==4%&& AllBehaviour(i,3)==0.14 %&& AllBehaviour(i,9)==2%&& AllBehaviour(i,3)==0.14%&& AllBehaviour(i,4)==4%&& AllBehaviour(i,4)==44
...
%     case 'CW_SL_b' %correct vs wrong; pre cue SL
        for i=1:length(AllBehaviour)
            %select trials
            if AllBehaviour(i,8)==1 &&AllBehaviour(i,4)==44%4&&AllBehaviour(i,3)==0.07 %&& AllBehaviour(i,9)==2%&&AllBehaviour(i,3)==0.07% AllBehaviour(i,4)==44%&& AllBehaviour(i,3)==0.07
                selected_trials_11(i)=1;
            elseif AllBehaviour(i,8)==2 &&AllBehaviour(i,4)==44%&&AllBehaviour(i,3)==0.07 %&& AllBehaviour(i,9)==1%&& AllBehaviour(i,3)==0.07%AllBehaviour(i,4)==44%&& AllBehaviour(i,3)==0.07
