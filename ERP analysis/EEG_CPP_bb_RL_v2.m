...
%load CPP19_RL_HL.mat  %
load CPP19_RL_FDIBCP.mat
...
xlabel('Time (ms)');
ylabel('Amplitude (µV)');
title(['ERP for Channel (RL) ', num2str(channel_to_plot)]);
hold off;
% Add vertical lines at specified time points
hold on;
xline([-1500, -120, 0], '--r', {'1.5 before EVoff', 'appx. respT', 'RT'});xlim([-600,100]);
hold off;
...
%% 画平均cpp
Ts_baseline=300:1000;
Ts_idx=1434:1800; % quick RT 0-500ms 
